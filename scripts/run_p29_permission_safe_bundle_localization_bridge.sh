#!/bin/bash -p
# Hash-bound, one-shot host orchestration for P29's bundle-complete bridge to
...
if [[ $EUID -ne 0 || ! -o privileged ]]; then
  echo "P29 sealed orchestrator requires a direct root invocation through /bin/bash -p" >&2
  exit 1
fi
...
for p29_loader_variable in $(compgen -A variable); do
  case "$p29_loader_variable" in
    LD_*|DYLD_*) unset "$p29_loader_variable" ;;
  esac
done
unset p29_loader_variable
...
unset p29_git_variable
for p29_docker_variable in $(compgen -A variable DOCKER_ || true); do
  unset "$p29_docker_variable"
done
unset p29_docker_variable

readonly P29_REQUIRED_ATTEMPT_ID=20260906-02
readonly P29_NAMESPACE_ROOT=/secure/p29
readonly P29_ATTEMPT_ROOT=/secure/p29/attempt-20260906-02
readonly P29_HOST_EVIDENCE="$P29_ATTEMPT_ROOT/evidence"
readonly P29_EXECUTION_ROOT=/secure/p29/execution-20260906-02
readonly P29_EXECUTION_MANIFEST="$P29_EXECUTION_ROOT/snapshot-manifest.json"
readonly P29_EXECUTION_DATA="$P29_EXECUTION_ROOT/data"
readonly P29_EXECUTION_TOOLS="$P29_EXECUTION_DATA/.p29-tools"
readonly P29_CANONICAL_NANOGPT_HOST=/secure/p23/nanoGPT
readonly P29_CANONICAL_MUON_HOST=/secure/p23/Muon
readonly P29_CANONICAL_DATA_HOST=/secure/p23/optimizationml-p22-data
readonly P29_CONTAINER=p29-localization-20260906-02
readonly P29_TRANSPORT_ROOT=/secure/p29/transport-20260906-02
readonly P29_SOURCE_BUNDLE="$P29_TRANSPORT_ROOT/p29_source.bundle"
readonly P29_RUNTIME_REVIEW_BUNDLE="$P29_TRANSPORT_ROOT/p29_runtime_review.bundle"
readonly P29_SOURCE_RECEIPT="$P29_TRANSPORT_ROOT/p29_source_bundle_receipt.json"
readonly P29_RUNTIME_REVIEW_RECEIPT="$P29_TRANSPORT_ROOT/p29_runtime_review_bundle_receipt.json"
readonly P29_SOURCE_CLOSURE="$P29_TRANSPORT_ROOT/p29_source_closure.git"
readonly P29_RUNTIME_REVIEW_CLOSURE="$P29_TRANSPORT_ROOT/p29_runtime_review_closure.git"
readonly P29_BOOTSTRAP_VERIFIER="$P29_TRANSPORT_ROOT/verify_p29_control_bundle.py"
readonly P29_CONTROL_REPO="$P29_TRANSPORT_ROOT/control-source"
readonly P29_LEDGER_ROOT=/var/lib/optimizationml-p29-20260906-02
readonly P29_DEFERRED_ROOT="$P29_LEDGER_ROOT/deferred"
readonly P29_SEALED_ORCHESTRATOR="$P29_LEDGER_ROOT/run_p29_permission_safe_bundle_localization_bridge.sh"
readonly P29_PREPARE_INVOCATION="$P29_LEDGER_ROOT/prepare-runtime.invoked"
readonly P29_LOCALIZATION_INVOCATION="$P29_LEDGER_ROOT/run-localization.invoked"
readonly P29_LOCALIZATION_AUTHORIZATION="$P29_LEDGER_ROOT/localization.authorized"
readonly P29_LOCALIZATION_EXIT_STATUS="$P29_LEDGER_ROOT/run-localization.exit-status.txt"
readonly P29_IMAGE_DIGEST=sha256:14dafde07ae578cc4725f452a51d4bc4c920b69f6af23125a72e27162e193ec0
readonly P29_IMAGE="localhost:5000/p25-runtime@$P29_IMAGE_DIGEST"
readonly P29_REQUIRED_GPU_UUID=GPU-ee4c9bf9-42f5-7cdd-66d2-f638c2db549d
readonly P29_REQUIRED_GPU_NAME='NVIDIA A100-SXM4-40GB'
readonly P29_AUTHORITY_HEAD=185e444afc0b44ca0a09b1bde49a6b6fa3973355
readonly P29_AUTHORITY_TREE=24f4bdac331a57bd7c1b807747d7c7fba253ee5a
readonly P29_TERMINAL_P28_COMMIT=7274367f2b05fb3c9ed9f876a59be647703bbdc2
readonly P29_TERMINAL_P28_TREE=8d971e176e664ea47d8f769ae54f8cf349ceb3d5
readonly P29_TERMINAL_P27_COMMIT=ec63550331925ded158e3f389e294e4d1f12db3a
readonly P29_TERMINAL_P27_TREE=d8efa72fda9ee41fde0b5d15b126aa87397cd48d
readonly P29_TERMINAL_P26_COMMIT=5429da23ff18888daa2312c530a4587780484d8b
readonly P29_TERMINAL_P26_CONTAINER_ID=e6682d8f09b9dc4be342354d520a8f6f8766a8e232840d1d7beb5e00e1fced6c
readonly P29_P26_NATIVE=/secure/p25/attempt-20260906-02/evidence/trace-off-a-failure.json
readonly P29_P26_NATIVE_SHA256=b2a92b5062988534bc424d3ecadf3977ecedc0f80aa27628d4a0457858a64c91
readonly P29_P26_NATIVE_BYTE_COUNT=66283
readonly P29_P25_SOURCE_SHA256=6305fb9683503eb67e091cdfb0a1105628fcb4bec76fe5ef7fd23dd49ba9d770
readonly P29_P25_CONTRACT_SHA256=51e1fc22f685cc904fcdfff2775cff4293fdaa67a6e048072ee4dc49777f34e2
readonly P29_P23_RUNNER_SHA256=a2b4bb5b686b7f681958d09be1d465917b40e34d45e4d3503efef0f35e7ae8cb
readonly P29_NANOGPT_COMMIT=3adf61e154c3fe3fca428ad6bc3818b27a3b8291
readonly P29_NANOGPT_TREE=ca93bcd9b9c9ff32d3016e1e2556644e68bef86a
readonly P29_MUON_COMMIT=f98f1cacc0263b04290753e32be8d498c1efc806
readonly P29_MUON_TREE=4ea5cd8ab6ebd56a18536f06453619efcd636da0
readonly P29_MUON_SOURCE_SHA256=2479665a90124f62e4df557816665851ca317e42fcfda2af1da02c1f44ab5f3d
readonly P29_FINEWEB_MANIFEST_SHA256=1dfbe2087fb61004c6c4ee938d1be53d769f2fa66303c2533e14acb9c1d5a96d
readonly P29_FINEWEB_MANIFEST_BYTE_COUNT=4210

die() {
  echo "P29 bundle-complete localization bridge blocked: $*" >&2
  exit 1
}
...
p29_docker() {
  sudo /usr/bin/env -i \
    ...
    --config /nonexistent/p29-docker-config \
    "$@"
}
...
seal_retained_file() {
  local path="$1"
  /usr/bin/python3 -I -S - \
    "$path" "$P29_HOST_EVIDENCE" "$P29_DEFERRED_ROOT" <<'PY'
import os
import pathlib
import stat
import sys
...
if expected_parent is None or path.name in {"", ".", ".."}:
    raise SystemExit("P29 retained file is outside a sealed output root")
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 retained-file parent authority differs")
    descriptor = os.open(
        path.name,
    ...
    if (
        ...
        raise SystemExit("P29 retained-file pre-seal authority differs")
    forbidden_acl = {
    ...
    for target, label in ((parent_fd, "parent"), (descriptor, "file")):
        ...
        if acl_names & forbidden_acl:
            raise SystemExit(f"P29 retained-file {label} has a forbidden ACL")
    os.fsync(descriptor)
    ...
    if fields(after) != fields(by_name):
        raise SystemExit("P29 retained-file path identity differs after sealing")
    if (
        ...
        raise SystemExit("P29 retained-file final authority differs")
    digest_after = digest_fd(descriptor)
    if digest_after != digest_before:
        raise SystemExit("P29 retained-file bytes changed while sealing")
    os.fsync(parent_fd)
finally:
...
seal_evidence_inventory() {
  /usr/bin/python3 -I -S - "$P29_HOST_EVIDENCE" <<'PY'
import os
import pathlib
import stat
import sys
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 evidence root authority differs during sealing")
    forbidden_acl = {
        "system.posix_acl_access",
        "system.posix_acl_default",
        "system.nfs4_acl",
    ...
    for name in sorted(os.listdir(descriptor)):
        ...
        try:
            if name in {"", ".", ".."} or "/" in name or "\x00" in name:
                raise RuntimeError("P29 evidence inventory contains an unsafe name")
            ...
            if (
                ...
                raise RuntimeError(f"P29 evidence child authority differs: {name}")
            acl_names = {
                value.decode() if isinstance(value, bytes) else value
                for value in os.listxattr(file_descriptor)
            }
            if acl_names & forbidden_acl:
                raise RuntimeError(f"P29 evidence child has a forbidden ACL: {name}")
            ...
            if fields(after) != fields(by_name) or (
                ...
                raise RuntimeError(f"P29 evidence child did not seal exactly: {name}")
    ...
    if failures:
        raise SystemExit(
            "P29 evidence inventory did not seal completely:\n" + "\n".join(failures)
        )
finally:
    os.close(descriptor)
PY
...
run_logged() {
  local label="$1"
  shift
  local stdout_path="$P29_HOST_EVIDENCE/$label.stdout.log"
  local stderr_path="$P29_HOST_EVIDENCE/$label.stderr.log"
  local status_path="$P29_HOST_EVIDENCE/$label.exit-status.txt"
...
create_admission_log_placeholders() {
  ...
  local stderr_path="$2"
  /usr/bin/python3 -I -S - \
    "$P29_DEFERRED_ROOT" "$stdout_path" "$stderr_path" <<'PY'
import os
import pathlib
import stat
import sys
...
if (
    ...
    raise SystemExit("P29 admission-log placeholder paths differ")
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 admission journal is not exactly empty and root-owned")
    forbidden_acl = {
        "system.posix_acl_access",
        "system.posix_acl_default",
        "system.nfs4_acl",
    ...
    if {
        ...
        raise SystemExit("P29 admission journal has a forbidden ACL")
    for path in (stdout_path, stderr_path):
        if path.name in {"", ".", ".."} or "/" in path.name or "\x00" in path.name:
            raise SystemExit("P29 admission-log placeholder name is unsafe")
        file_descriptor = os.open(
            path.name,
        ...
        if (
            ...
            raise SystemExit("P29 admission-log placeholder authority differs")
    os.fsync(descriptor)
finally:
...
run_root_journal_logged() {
  ...
  local label="$1"
  shift
  [[ "$label" == "p29-prepare-pre-attempt-admission" ]] ||
    die "root-journal logging is restricted to the preregistered admission boundary"
  local prefix="$P29_DEFERRED_ROOT/.deferred-$label"
...
run_logged_deferred_evidence() {
  ...
  local label="$1"
  shift
  [[ "$label" == "p29-prepare-attempt-layout" || \
     "$label" == "p29-pre-marker-runtime-receipt-replay" ]] ||
    die "deferred evidence logging is restricted to preregistered boundaries"
  local external_prefix="$P29_DEFERRED_ROOT/.deferred-$label"
  ...
  local evidence_stdout="$P29_HOST_EVIDENCE/$label.stdout.log"
  local evidence_stderr="$P29_HOST_EVIDENCE/$label.stderr.log"
  local evidence_status="$P29_HOST_EVIDENCE/$label.exit-status.txt"
  local path
  for path in \
  ...
  if [[ "$label" == "p29-pre-marker-runtime-receipt-replay" ]]; then
    reviewed_receipt="$P29_RUNTIME_REVIEW_RECEIPT"
    ...
    reviewed_receipt_sha256="${P29_EXPECTED_RUNTIME_REVIEW_RECEIPT_SHA256:-}"
  fi
  ...
  set -o noclobber
  /usr/bin/python3 -I -S - \
    "$P29_DEFERRED_ROOT" "$P29_TRANSPORT_ROOT" "$P29_HOST_EVIDENCE" \
    "$P29_EXECUTION_ROOT" "$label" \
...
def mount_id(descriptor: int) -> int:
    ...
    raise SystemExit("P29 deferred-log descriptor has no mount ID")
...
def require_no_acl(descriptor: int, name: str) -> None:
    ...
    if names & {
        ...
        raise SystemExit(f"P29 deferred-log {name} has a forbidden ACL")
...
def stable_regular_bytes(
    ...
    try:
        ...
        if (
            ...
            raise SystemExit("P29 deferred-log reviewed receipt authority differs")
        chunks = []
        while True:
        ...
        if fields(before) != fields(after) or fields(after) != fields(by_name):
            raise SystemExit("P29 deferred-log reviewed receipt changed during read")
...
try:
    for descriptor, expected, label in (
        ...
        if (
            ...
            raise SystemExit(f"P29 deferred-log {label} authority differs")
    ...
    if (
        ...
        raise SystemExit("P29 deferred-log attempt authority differs")
    ...
    if (
        ...
        raise SystemExit("P29 deferred-log execution authority differs")
    ...
    if fields(evidence_info) != fields(evidence_by_name):
        raise SystemExit("P29 deferred-log evidence path identity differs")
    if (
        len(
            {
                os.fstat(fd).st_dev
        ...
        raise SystemExit("P29 deferred-log paths cross a device or mount boundary")
    if receipt is not None:
        if receipt.parent != transport or receipt.name in {"", ".", ".."}:
            raise SystemExit("P29 deferred-log reviewed receipt path differs")
        ...
        if hashlib.sha256(receipt_raw).hexdigest() != expected_receipt_digest:
            raise SystemExit("P29 deferred-log reviewed receipt digest differs")
        try:
            ...
            raise SystemExit("P29 deferred-log reviewed receipt is malformed") from exc
        for current, expected, name in (
            ...
            for key, value in observed.items():
                if expected.get(key) != value:
                    raise SystemExit(
                        f"P29 deferred-log reviewed {name} identity differs at {key}"
                    )
    for source_name, destination_name in pairs:
        if "/" in source_name or "/" in destination_name:
            raise SystemExit("P29 deferred-log filename is not one direct child")
        ...
        try:
            ...
            if (
                ...
                raise SystemExit("P29 deferred-log source authority differs")
            ...
            while True:
                ...
                while view:
                    ...
                    if written <= 0:
                        raise SystemExit("P29 deferred-log copy made no progress")
                    view = view[written:]
            ...
            if fields(before) != fields(after) or fields(after) != fields(source_by_name):
                raise SystemExit("P29 deferred-log source changed during publication")
            if (
                ...
                raise SystemExit("P29 deferred-log destination authority differs")
            ...
            if destination_digest.digest() != source_digest.digest():
                raise SystemExit("P29 deferred-log destination bytes differ")
            ...
            if (
                ...
                raise SystemExit("P29 deferred-log destination identity changed")
  ...
  (
    ...
    set -o noclobber
    {
      ...
      [[ "$(/usr/bin/stat -c '%d:%i:%a:%u:%g:%h' "$output")" == \
          "$output_binding" ]] || {
        echo "P29 bound evidence output identity changed: $output" >&2
        exit 1
      }
      [[ -s "$output" ]] || {
        echo "P29 bound evidence capture is empty: $label" >&2
        exit 1
      }
    } 2>"$stderr_path"
  )
...
write_new_status() {
  ...
  local value="$2"
  /usr/bin/python3 -I -S - \
    "$output" "$value" "$P29_HOST_EVIDENCE" "$P29_DEFERRED_ROOT" <<'PY'
import os
import pathlib
import stat
import sys
...
if not path.is_absolute() or path.name in {"", ".", ".."}:
    raise SystemExit("P29 status path is not one absolute direct-child path")
for name in ("O_CLOEXEC", "O_DIRECTORY", "O_NOFOLLOW"):
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 status parent authority differs")
    acl_names = {
    ...
    if acl_names & {
        ...
        raise SystemExit("P29 status parent has a forbidden ACL")
    descriptor = os.open(
        path.name,
        os.O_RDWR | os.O_CREAT | os.O_EXCL | os.O_CLOEXEC | os.O_NOFOLLOW,
        0o600,
    ...
    while view:
        ...
        if written <= 0:
            raise SystemExit("P29 status write made no progress")
        view = view[written:]
    os.fsync(descriptor)
    ...
    if (
        ...
        raise SystemExit("P29 status authority or size differs")
    ...
    if bytes(observed) != payload or os.read(descriptor, 1) != b"":
        raise SystemExit("P29 status stored bytes differ")
    os.fchmod(descriptor, expected_parent[1])
    os.fsync(descriptor)
    created = os.fstat(descriptor)
    by_name = os.stat(path.name, dir_fd=parent_fd, follow_symlinks=False)
    if (
        ...
        raise SystemExit("P29 status path identity differs")
    os.fsync(parent_fd)
finally:
    if descriptor is not None:
        try:
...
validate_deferred_journal() {
  ...
  /usr/bin/python3 -I -S - \
    "$P29_DEFERRED_ROOT" "$stage" "$admission_status" <<'PY'
import os
import pathlib
import stat
import sys
...
try:
    ...
    raise SystemExit("P29 admission status is malformed") from exc
if not 0 <= admission_status <= 255 or sys.argv[3] != str(admission_status):
    raise SystemExit("P29 admission status is noncanonical")
labels = {
    "empty": (),
    "after-admission": (),
    "after-prepare": ("p29-prepare-attempt-layout",),
    "after-runtime": (
        "p29-prepare-attempt-layout",
        "p29-pre-marker-runtime-receipt-replay",
    ),
}.get(stage)
if labels is None:
    raise SystemExit("P29 deferred-journal stage is malformed")
directory_flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
descriptor = os.open("/", directory_flags)
try:
    for component in journal.parts[1:]:
    ...
    if (
        ...
        raise SystemExit("P29 deferred-journal authority differs")
    forbidden_acl = {
        "system.posix_acl_access",
        "system.posix_acl_default",
        "system.nfs4_acl",
    ...
    if {
        ...
        raise SystemExit("P29 deferred journal has a forbidden ACL")
    expected = []
    if stage != "empty":
        expected.extend(
            (
    ...
    if sorted(os.listdir(descriptor)) != sorted(expected):
        raise SystemExit("P29 deferred-journal inventory differs")
    for name in sorted(expected):
        ...
        try:
            ...
            if (
                ...
                raise SystemExit(f"P29 deferred-journal file authority differs: {name}")
            if {
                value.decode() if isinstance(value, bytes) else value
                for value in os.listxattr(file_descriptor)
            } & forbidden_acl:
                raise SystemExit(f"P29 deferred-journal file has an ACL: {name}")
            raw = bytearray()
            while True:
            ...
            if fields(before) != fields(after) or fields(after) != fields(by_name):
                raise SystemExit(f"P29 deferred-journal file changed: {name}")
            expected_status = b"0\n"
            if (
            ...
            if name.endswith(".exit-status.txt") and bytes(raw) != expected_status:
                raise SystemExit(f"P29 deferred status differs: {name}")
            if ".publication." in name and name.endswith(("stdout.log", "stderr.log")):
                if raw:
                    raise SystemExit(f"P29 publication transcript is not empty: {name}")
        finally:
            os.close(file_descriptor)
finally:
    os.close(descriptor)
...
validate_localization_ledger() {
  ...
  sudo /usr/bin/python3 -I -S - \
    "$P29_LEDGER_ROOT" "$P29_DEFERRED_ROOT" "$P29_SEALED_ORCHESTRATOR" \
    "$P29_PREPARE_INVOCATION" "$P29_LOCALIZATION_INVOCATION" \
    "$P29_LOCALIZATION_AUTHORIZATION" "$P29_LOCALIZATION_EXIT_STATUS" \
    "$prepare_state" "$invocation_state" "$authorization_state" "$status_state" \
    "$P29_EXPECTED_ORCHESTRATOR_SHA256" <<'PY'
import hashlib
import os
import pathlib
import stat
...
if ledger != pathlib.PurePosixPath("/var/lib/optimizationml-p29-20260906-02"):
    raise SystemExit("P29 localization ledger path differs")
if (
    deferred != ledger / "deferred"
    or sealed_orchestrator != ledger / "run_p29_permission_safe_bundle_localization_bridge.sh"
    ...
    raise SystemExit("P29 localization ledger child path differs")
if any(value not in {"absent", "present"} for value in (
    ...
    raise SystemExit("P29 localization ledger expectation is malformed")
if invocation_state == "present" and prepare_state != "present":
    raise SystemExit("P29 localization invocation cannot precede prepare admission")
if authorization_state == "present" and invocation_state != "present":
    raise SystemExit("P29 localization authorization cannot precede invocation")
if status_state == "present" and invocation_state != "present":
    raise SystemExit("P29 localization status cannot precede invocation")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
descriptor = os.open("/", flags)
try:
    ...
    if (
        ...
        raise SystemExit("P29 localization ledger authority differs")
    acl_names = {
        name.decode() if isinstance(name, bytes) else name
    ...
    if acl_names & {
        ...
        raise SystemExit("P29 localization ledger has a forbidden ACL")
    ...
    if sorted(os.listdir(descriptor)) != sorted(expected_names):
        raise SystemExit("P29 localization ledger inventory differs")
    ...
    try:
        ...
        if fields(before) != fields(after) or fields(after) != fields(by_name):
            raise SystemExit("P29 sealed orchestrator changed during read")
        if digest.hexdigest() != expected_orchestrator_sha256:
            raise SystemExit("P29 sealed orchestrator digest differs")
        if {
            name.decode() if isinstance(name, bytes) else name
            for name in os.listxattr(orchestrator_fd)
        } & forbidden_acl:
            raise SystemExit("P29 sealed orchestrator has a forbidden ACL")
    finally:
    ...
    for name, expected_payload, is_status in expected_tokens:
        ...
        if (
            ...
            raise SystemExit(f"P29 localization ledger file authority differs: {name}")
        token_fd = os.open(
            name,
            os.O_RDONLY | os.O_CLOEXEC | os.O_NOFOLLOW,
            dir_fd=descriptor,
        ...
        try:
            ...
            if os.read(token_fd, 1) != b"":
                raise SystemExit("P29 localization ledger file is unexpectedly large")
            ...
            if fields(before) != fields(after) or fields(after) != fields(by_name):
                raise SystemExit("P29 localization ledger file changed during read")
            if is_status:
                try:
                    parsed = int(payload.strip())
                except ValueError as exc:
                    raise SystemExit("P29 localization status payload is malformed") from exc
                if payload != f"{parsed}\n".encode("ascii") or not 0 <= parsed <= 255:
                    raise SystemExit("P29 localization status payload differs")
            elif payload != expected_payload:
                raise SystemExit(f"P29 localization token payload differs: {name}")
        finally:
            os.close(token_fd)
    mount_points = {
    ...
    if str(ledger) in mount_points:
        raise SystemExit("P29 localization ledger is an unexpected mount point")
finally:
    os.close(descriptor)
PY
}
...
create_localization_token() {
  ...
  case "$kind" in
    prepare)
      ...
      ;;
    invocation)
      token="$P29_LOCALIZATION_INVOCATION"
      payload=run-localization
      expected_before=$'deferred\nprepare-runtime.invoked\nrun_p29_permission_safe_bundle_localization_bridge.sh'
      expected_after=$'deferred\nprepare-runtime.invoked\nrun-localization.invoked\nrun_p29_permission_safe_bundle_localization_bridge.sh'
      ;;
    authorization)
      token="$P29_LOCALIZATION_AUTHORIZATION"
      payload=localization-authorized
      expected_before=$'deferred\nprepare-runtime.invoked\nrun-localization.invoked\nrun_p29_permission_safe_bundle_localization_bridge.sh'
      expected_after=$'deferred\nlocalization.authorized\nprepare-runtime.invoked\nrun-localization.invoked\nrun_p29_permission_safe_bundle_localization_bridge.sh'
      ;;
    *) die "P29 localization-token kind is malformed" ;;
  esac
  sudo /usr/bin/python3 -I -S - \
    "$P29_LEDGER_ROOT" "$token" "$payload" "$expected_before" "$expected_after" \
    "$P29_EXPECTED_ORCHESTRATOR_SHA256" <<'PY'
import hashlib
import os
import pathlib
...
if (
    ...
    raise SystemExit("P29 expected sealed-orchestrator digest is malformed")
if token.parent != ledger or token.name not in {
    "prepare-runtime.invoked",
    "run-localization.invoked",
    "localization.authorized",
}:
    raise SystemExit("P29 localization token path differs")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
...
try:
    ...
    if sorted(os.listdir(ledger_fd)) != expected_before:
        raise SystemExit("P29 localization ledger pre-inventory differs")
    forbidden_acl = {
        "system.posix_acl_access",
        "system.posix_acl_default",
        "system.nfs4_acl",
    ...
    if (
        ...
        raise SystemExit("P29 deferred journal authority differs before token creation")
    orchestrator_fd = os.open(
        "run_p29_permission_safe_bundle_localization_bridge.sh",
        os.O_RDONLY | os.O_CLOEXEC | os.O_NOFOLLOW,
        dir_fd=ledger_fd,
    ...
    try:
        ...
        if (
            ...
            raise SystemExit("P29 sealed orchestrator differs before token creation")
    finally:
        os.close(orchestrator_fd)
    token_fd = os.open(
        token.name,
    ...
    while view:
        ...
        if written <= 0:
            raise SystemExit("P29 localization token write made no progress")
        view = view[written:]
    ...
    if (
        ...
        raise SystemExit("P29 localization token stored authority differs")
    if sorted(os.listdir(ledger_fd)) != expected_after:
        raise SystemExit("P29 localization ledger post-inventory differs")
    ...
    if (
        ...
        raise SystemExit("P29 deferred journal changed during token creation")
    os.fsync(ledger_fd)
finally:
...
write_localization_exit_status() {
  ...
  [[ "$status" =~ ^[0-9]+$ && "$status" -le 255 ]] ||
    die "P29 localization exit status is malformed"
  sudo /usr/bin/python3 -I -S - \
    "$P29_LEDGER_ROOT" "$P29_LOCALIZATION_EXIT_STATUS" "$status" \
    "$P29_EXPECTED_ORCHESTRATOR_SHA256" <<'PY'
import hashlib
import os
import pathlib
...
if path != ledger / "run-localization.exit-status.txt":
    raise SystemExit("P29 localization status path differs")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
ledger_fd = os.open("/", flags)
file_fd = None
deferred_fd = None
try:
    ...
    if names != sorted(allowed):
        raise SystemExit("P29 localization ledger pre-status inventory differs")
    ...
    if (
        ...
        raise SystemExit("P29 deferred journal differs before terminal status")
    ...
    try:
        ...
        if (
            ...
            raise SystemExit("P29 sealed orchestrator differs before terminal status")
    finally:
        os.close(orchestrator_fd)
    ...
    def require_token(name, expected):
        ...
        try:
            ...
            if (
                ...
                raise SystemExit(f"P29 localization token authority differs: {name}")
            ...
            if fields(before) != fields(after) or fields(after) != fields(by_name):
                raise SystemExit(f"P29 localization token changed: {name}")
            if observed != expected:
                raise SystemExit(f"P29 localization token bytes differ: {name}")
        finally:
            os.close(descriptor)
    ...
    while view:
        ...
        if written <= 0:
            raise SystemExit("P29 localization status write made no progress")
        view = view[written:]
    ...
    if (
        ...
        raise SystemExit("P29 localization status authority differs")
    os.lseek(file_fd, 0, os.SEEK_SET)
    observed = os.read(file_fd, len(payload) + 1)
    if observed != payload:
        raise SystemExit("P29 localization status stored bytes differ")
    expected_after = sorted([*allowed, path.name])
    if sorted(os.listdir(ledger_fd)) != expected_after:
        raise SystemExit("P29 localization ledger post-status inventory differs")
    deferred_after = os.fstat(deferred_fd)
    deferred_by_name_after = os.stat(
        "deferred", dir_fd=ledger_fd, follow_symlinks=False
    )
    if (
        ...
        raise SystemExit("P29 deferred journal changed during terminal status")
    os.fsync(ledger_fd)
finally:
...
validate_root_evidence_file() {
  ...
  sudo /usr/bin/python3 -I -S - \
    "$P29_HOST_EVIDENCE" "$path" "$expected_sha256" \
...
if path.parent != evidence or path.name in {"", ".", ".."}:
    raise SystemExit("P29 retained file is not a direct evidence child")
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 evidence-directory authority differs")
    ...
    if (
        ...
        raise SystemExit("P29 retained-file type, link count, owner, or mode differs")
    acl_names = {
        name.decode() if isinstance(name, bytes) else name
    ...
    if acl_names & {
        ...
        raise SystemExit("P29 retained file has a forbidden ACL")
    digest = hashlib.sha256()
    while True:
    ...
    if (
        ...
        raise SystemExit("P29 retained-file identity or metadata changed during read")
    actual_digest = digest.hexdigest()
    if expected_digest != "-" and actual_digest != expected_digest:
        raise SystemExit("P29 retained-file SHA-256 differs")
    if expected_size_text != "-" and after.st_size != int(expected_size_text):
        raise SystemExit("P29 retained-file byte count differs")
    mount_points = {
        line.split()[4].replace("\\040", " ").replace("\\011", "\t")
        for line in pathlib.Path("/proc/self/mountinfo").read_text().splitlines()
        if len(line.split()) >= 5
    ...
    if str(path) in mount_points:
        raise SystemExit("P29 retained file is an unexpected mount point")
    print(
...
read_sealed_evidence_line() {
  local path="$1"
  local pattern="$2"
  /usr/bin/python3 -I -S - "$P29_HOST_EVIDENCE" "$path" "$pattern" <<'PY'
import os
import pathlib
import re
import stat
...
pattern = sys.argv[3]
if path.parent != evidence or path.name in {"", ".", ".."}:
    raise SystemExit("P29 sealed-line path differs")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 sealed-line authority differs")
    raw = os.read(descriptor, 4096)
    if os.read(descriptor, 1) != b"":
        raise SystemExit("P29 sealed-line input is unexpectedly large")
    after = os.fstat(descriptor)
    by_name = os.stat(path.name, dir_fd=parent_fd, follow_symlinks=False)
    fields = lambda value: (
        value.st_dev,
    ...
    if fields(before) != fields(after) or fields(after) != fields(by_name):
        raise SystemExit("P29 sealed-line input changed during read")
    try:
        value = raw.decode("ascii").removesuffix("\n")
    except UnicodeDecodeError as exc:
        raise SystemExit("P29 sealed-line input is not ASCII") from exc
    if raw != (value + "\n").encode("ascii") or re.fullmatch(pattern, value) is None:
        raise SystemExit("P29 sealed-line payload differs")
    print(value)
finally:
    if descriptor is not None:
        os.close(descriptor)
...
require_source_environment() {
  [[ "$(/usr/bin/id -u)" == "0" && "$(/usr/bin/id -g)" == "0" ]] ||
    die "P29 host orchestration must run as root from the sealed orchestrator"
  require_var P29_ATTEMPT_ID
  [[ "$P29_ATTEMPT_ID" == "$P29_REQUIRED_ATTEMPT_ID" ]] ||
    die "P29_ATTEMPT_ID must equal $P29_REQUIRED_ATTEMPT_ID"
  require_var P29_GPU_UUID
  [[ "$P29_GPU_UUID" == "$P29_REQUIRED_GPU_UUID" ]] ||
    die "P29_GPU_UUID differs from the preregistered full A100 UUID"
  require_absolute_path P29_AUTHORITY_REPO
  [[ "$P29_AUTHORITY_REPO" == "$P29_TRANSPORT_ROOT/authority-185e444" ]] ||
    die "P29_AUTHORITY_REPO differs from the transport-contained authority path"
  require_absolute_path P29_NANOGPT_HOST
  require_absolute_path P29_MUON_HOST
  require_absolute_path P29_DATA_HOST
  [[ "$P29_NANOGPT_HOST" == "$P29_CANONICAL_NANOGPT_HOST" ]] ||
    die "P29_NANOGPT_HOST differs from the frozen canonical source"
  [[ "$P29_MUON_HOST" == "$P29_CANONICAL_MUON_HOST" ]] ||
    die "P29_MUON_HOST differs from the frozen canonical source"
  [[ "$P29_DATA_HOST" == "$P29_CANONICAL_DATA_HOST" ]] ||
    die "P29_DATA_HOST differs from the frozen canonical source"
  require_commit P29_SOURCE_FREEZE_COMMIT
  require_commit P29_SOURCE_FREEZE_TREE
  require_sha256 P29_EXPECTED_SOURCE_BUNDLE_SHA256
  require_var P29_EXPECTED_SOURCE_BUNDLE_BYTE_COUNT
  [[ "$P29_EXPECTED_SOURCE_BUNDLE_BYTE_COUNT" =~ ^[1-9][0-9]*$ ]] ||
    die "P29_EXPECTED_SOURCE_BUNDLE_BYTE_COUNT is not a positive integer"
  require_sha256 P29_EXPECTED_SOURCE_RECEIPT_SHA256
  require_sha256 P29_EXPECTED_CONTRACT_SHA256
  require_sha256 P29_EXPECTED_ORCHESTRATOR_SHA256
  require_sha256 P29_EXPECTED_RECONSTRUCTOR_SHA256
  require_sha256 P29_EXPECTED_BUNDLE_VERIFIER_SHA256
  require_sha256 P29_EXPECTED_P28_CONTRACT_SHA256
  require_sha256 P29_EXPECTED_P28_RECONSTRUCTOR_SHA256
  require_sha256 P29_EXPECTED_P28_OUTCOME_SHA256
  require_sha256 P29_EXPECTED_P28_OUTCOME_RECONSTRUCTOR_SHA256
  require_sha256 P29_EXPECTED_P27_CONTRACT_SHA256
  require_sha256 P29_EXPECTED_P27_RECONSTRUCTOR_SHA256
  require_sha256 P29_EXPECTED_P27_LOCALIZER_SHA256
  require_sha256 P29_EXPECTED_INGESTER_SHA256
  require_sha256 P29_EXPECTED_P23_CORE_SHA256
  require_sha256 P29_EXPECTED_P27_SANITIZER_SHA256
}

require_runtime_environment() {
  require_source_environment
  require_commit P29_RUNTIME_REVIEW_COMMIT
  require_commit P29_RUNTIME_REVIEW_TREE
  require_sha256 P29_EXPECTED_RUNTIME_REVIEW_BUNDLE_SHA256
  require_var P29_EXPECTED_RUNTIME_REVIEW_BUNDLE_BYTE_COUNT
  [[ "$P29_EXPECTED_RUNTIME_REVIEW_BUNDLE_BYTE_COUNT" =~ ^[1-9][0-9]*$ ]] ||
    die "P29_EXPECTED_RUNTIME_REVIEW_BUNDLE_BYTE_COUNT is not a positive integer"
  require_sha256 P29_EXPECTED_RUNTIME_REVIEW_RECEIPT_SHA256
  require_sha256 P29_EXPECTED_RUNTIME_LOCK_SHA256
  require_sha256 P29_EXPECTED_HOST_ATTESTATION_SHA256
  require_var P29_EXPECTED_CONTAINER_ID
  [[ "$P29_EXPECTED_CONTAINER_ID" =~ ^[0-9a-f]{64}$ ]] ||
    die "P29_EXPECTED_CONTAINER_ID is not one full container ID"
}
...
assert_clean_checkout() {
  ...
  set +e
  config_output="$(p29_git --git-dir="$repository/.git" config --local --no-includes \
  ...
  [[ "$(p29_git --git-dir="$repository/.git" rev-parse --is-shallow-repository)" == \
      "false" ]] || die "$label checkout is shallow"
  local replace_refs
  replace_refs="$(p29_git --git-dir="$repository/.git" for-each-ref \
  ...
  actual_top_level="$(p29_git -C "$repository" rev-parse --show-toplevel)" ||
  ...
  actual_git_dir="$(p29_git -C "$repository" rev-parse --absolute-git-dir)" ||
  ...
  actual_head="$(p29_git -C "$repository" rev-parse HEAD)" ||
    die "$label HEAD could not be resolved"
  [[ "$actual_head" == "$head" ]] ||
    die "$label HEAD differs"
  actual_tree="$(p29_git -C "$repository" rev-parse HEAD^{tree})" ||
    die "$label tree could not be resolved"
  [[ "$actual_tree" == "$tree" ]] ||
    die "$label tree differs"
  status_output="$(p29_git -C "$repository" status --porcelain=v1 \
...
validate_namespace_layout() {
  /usr/bin/python3 -I -S - \
    "$P29_NAMESPACE_ROOT" "$P29_TRANSPORT_ROOT" "$P29_CONTROL_REPO" \
    "$P29_AUTHORITY_REPO" "$P29_ATTEMPT_ROOT" "$P29_EXECUTION_ROOT" <<'PY'
import os
import pathlib
import stat
import sys
...
if secure_parent != pathlib.PurePosixPath("/secure"):
    raise SystemExit("P29 secure-parent path differs")
if namespace != pathlib.PurePosixPath("/secure/p29"):
    raise SystemExit("P29 namespace path differs")
if transport != namespace / "transport-20260906-02":
    raise SystemExit("P29 transport path differs")
if control != transport / "control-source":
    raise SystemExit("P29 control checkout is not transport-contained")
if authority != transport / "authority-185e444":
    raise SystemExit("P29 authority checkout is not transport-contained")
if attempt != namespace / "attempt-20260906-02":
    raise SystemExit("P29 attempt-root path differs")
if execution != namespace / "execution-20260906-02":
    raise SystemExit("P29 execution-root path differs")
...
def mount_id(descriptor: int) -> int:
    for line in pathlib.Path(f"/proc/self/fdinfo/{descriptor}").read_text().splitlines():
        if line.startswith("mnt_id:"):
            return int(line.split(":", 1)[1])
    raise SystemExit("P29 directory descriptor has no mount ID")
...
def bind_directory(path: pathlib.PurePosixPath) -> tuple[int, int, int, int, int, int]:
    ...
    try:
        ...
        if not stat.S_ISDIR(value.st_mode):
            raise SystemExit(f"P29 path is not a directory: {path}")
        acl_names = {
            name.decode() if isinstance(name, bytes) else name
            for name in os.listxattr(descriptor)
        }
        ...
        if acl_names & forbidden:
            raise SystemExit(f"P29 path has an ACL: {path}")
        return (
            value.st_dev,
            value.st_ino,
            value.st_uid,
...
if first_secure_parent[2:5] != (0, 0, 0o755):
    raise SystemExit("P29 secure-parent owner or mode differs")
if first_namespace[2:5] != (0, 0, 0o755):
    raise SystemExit("P29 namespace owner or mode differs")
if first_transport[2:5] != (1000, 1000, 0o700):
    raise SystemExit("P29 transport owner or mode differs")
if len({first_secure_parent[0], first_namespace[0], first_transport[0]}) != 1:
    raise SystemExit("P29 secure parent, namespace, and transport are on different devices")
if len({first_secure_parent[5], first_namespace[5], first_transport[5]}) != 1:
    raise SystemExit("P29 secure parent, namespace, and transport cross a mount-ID boundary")
...
if namespace_children not in allowed_inventories:
    raise SystemExit(
        "P29 namespace child inventory differs from the sole-capability layout: "
...
if any(str(path) in mount_points for path in (secure_parent, namespace, transport)):
    raise SystemExit("P29 secure parent, namespace, or transport is an unexpected mount point")

if bind_directory(secure_parent) != first_secure_parent:
    raise SystemExit("P29 secure-parent identity changed during validation")
if bind_directory(namespace) != first_namespace:
    raise SystemExit("P29 namespace identity changed during validation")
if bind_directory(transport) != first_transport:
    raise SystemExit("P29 transport identity changed during validation")
PY
}

validate_fresh_attempt_layout() {
  /usr/bin/python3 -I -S - \
    "$P29_NAMESPACE_ROOT" "$P29_TRANSPORT_ROOT" \
    "$P29_ATTEMPT_ROOT" "$P29_HOST_EVIDENCE" "$P29_EXECUTION_ROOT" <<'PY'
import os
import pathlib
import stat
import sys
...
secure_parent = namespace.parent
if secure_parent != pathlib.PurePosixPath("/secure"):
    raise SystemExit("P29 runtime secure-parent layout differs")
if transport != namespace / "transport-20260906-02":
    raise SystemExit("P29 transport layout differs")
if attempt != namespace / "attempt-20260906-02" or evidence != attempt / "evidence":
    raise SystemExit("P29 attempt layout differs")
if execution != namespace / "execution-20260906-02":
    raise SystemExit("P29 execution snapshot layout differs")
...
def mount_id(descriptor: int) -> int:
    for line in pathlib.Path(f"/proc/self/fdinfo/{descriptor}").read_text().splitlines():
        if line.startswith("mnt_id:"):
            return int(line.split(":", 1)[1])
    raise SystemExit("P29 attempt descriptor has no mount ID")
...
def require_authority(
    ...
    if not stat.S_ISDIR(value.st_mode) or actual != expected:
        raise SystemExit(f"P29 attempt component authority differs: {path}")
    acl_names = {
        name.decode() if isinstance(name, bytes) else name
        for name in os.listxattr(descriptor)
    }
    ...
    if acl_names & forbidden:
        raise SystemExit(f"P29 attempt component has an ACL: {path}")
    return (
        value.st_dev,
        value.st_ino,
        value.st_uid,
...
namespace_fd = os.open("p29", flags, dir_fd=secure_parent_fd)
try:
    namespace_children = sorted(os.listdir(namespace_fd))
    if namespace_children != [
        ...
        raise SystemExit(f"P29 runtime namespace inventory differs: {namespace_children!r}")
    transport_fd = os.open("transport-20260906-02", flags, dir_fd=namespace_fd)
    try:
        attempt_fd = os.open("attempt-20260906-02", flags, dir_fd=namespace_fd)
        try:
            execution_fd = os.open("execution-20260906-02", flags, dir_fd=namespace_fd)
            try:
                ...
                try:
                    ...
                    if len(devices) != 1 or len(mounts) != 1:
                        raise SystemExit(
                            "P29 runtime layout crosses a device or mount-ID boundary"
                        )
                    for path, descriptor, record in (
                        ...
                        if stat.S_ISLNK(by_name.st_mode) or (
                            ...
                            raise SystemExit(
                                f"P29 runtime component path identity differs: {path}"
                            )
                        descriptor_info = os.fstat(descriptor)
                        if (descriptor_info.st_dev, descriptor_info.st_ino) != record[:2]:
                            raise SystemExit(
                                f"P29 runtime component descriptor identity differs: {path}"
                            )
                    ...
                    if execution_children != [
                        ...
                        raise SystemExit(
                            f"P29 execution top-level inventory differs: {execution_children!r}"
                        )
                    ...
                    if (
                        ...
                        raise SystemExit("P29 execution manifest authority differs")
                finally:
                    os.close(evidence_fd)
            finally:
                os.close(execution_fd)
...
if any(
    ...
    raise SystemExit("P29 runtime component is an unexpected mount point")
print(
    "|".join(
...
validate_expected_attempt_layout() {
  ...
  [[ "$actual_binding" == "$expected_binding" ]] ||
    die "P29 attempt or evidence directory identity changed"
  echo "$actual_binding"
}
...
validate_attempt_layout_against_log() {
  ...
  expected_binding="$(/usr/bin/python3 -I -S - \
    "$P29_HOST_EVIDENCE" "$binding_log" <<'PY'
import os
import pathlib
import re
import stat
...
path = pathlib.PurePosixPath(sys.argv[2])
if path.parent != evidence or path.name in {"", ".", ".."}:
    raise SystemExit("P29 attempt-binding log is not a direct evidence child")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 attempt-binding evidence authority differs")
    ...
    if (
        ...
        raise SystemExit("P29 attempt-binding log authority differs")
    chunks = []
    while True:
    ...
    if fields(before) != fields(after) or fields(after) != fields(by_name):
        raise SystemExit("P29 attempt-binding log changed during read")
    raw = b"".join(chunks)
    try:
        text = raw.decode("ascii")
    except UnicodeDecodeError as exc:
        raise SystemExit("P29 attempt-binding log is not ASCII") from exc
    pattern = (
    ...
    if re.fullmatch(pattern, text) is None:
        raise SystemExit("P29 attempt-binding log payload is malformed")
    ...
    os.close(evidence_fd)
PY
  )" || die "P29 retained attempt binding could not be authenticated"
  validate_expected_attempt_layout "$expected_binding"
}

validate_runtime_namespace_against_receipt() {
  /usr/bin/python3 -I -S - \
    "$P29_RUNTIME_REVIEW_RECEIPT" "$P29_EXPECTED_RUNTIME_REVIEW_RECEIPT_SHA256" \
    "$P29_NAMESPACE_ROOT" "$P29_TRANSPORT_ROOT" "$P29_ATTEMPT_ROOT" \
    "$P29_HOST_EVIDENCE" "$P29_EXECUTION_ROOT" <<'PY'
import hashlib
import json
import os
import pathlib
...
secure_parent = namespace.parent
if receipt != transport / "p29_runtime_review_bundle_receipt.json":
    raise SystemExit("P29 reviewed runtime receipt path differs")
expected_paths = {
...
def mount_id(descriptor):
    for line in pathlib.Path(f"/proc/self/fdinfo/{descriptor}").read_text().splitlines():
        if line.startswith("mnt_id:"):
            return int(line.split(":", 1)[1])
    raise SystemExit("P29 receipt-bound descriptor lacks a mount ID")
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 reviewed runtime receipt authority differs")
    raw = bytearray()
    while True:
    ...
    if fields(before) != fields(after) or fields(after) != fields(by_name):
        raise SystemExit("P29 reviewed runtime receipt changed during read")
finally:
    if receipt_fd is not None:
        os.close(receipt_fd)
    os.close(transport_fd)
if hashlib.sha256(raw).hexdigest() != expected_receipt_sha256:
    raise SystemExit("P29 reviewed runtime receipt digest differs")
try:
    payload = json.loads(
        bytes(raw),
    ...
    raise SystemExit("P29 reviewed runtime receipt is malformed") from exc
top_records = {
...
try:
    for label, path in expected_paths.items():
        ...
        if not isinstance(record, dict) or record.get("path") != str(path):
            raise SystemExit(f"P29 reviewed {label} receipt record differs")
        ...
        if (info.st_uid, info.st_gid, observed["mode_octal"]) != (uid, gid, mode):
            raise SystemExit(f"P29 current {label} authority differs")
        for key, value in observed.items():
            if record.get(key) != value:
                raise SystemExit(f"P29 current {label} differs from receipt at {key}")
        acl_names = {
        ...
        if acl_names & {
            ...
            raise SystemExit(f"P29 current {label} has a forbidden ACL")
    if len({os.fstat(value).st_dev for value in descriptors.values()}) != 1:
        raise SystemExit("P29 receipt-bound namespace crosses devices")
    if len({mount_id(value) for value in descriptors.values()}) != 1:
        raise SystemExit("P29 receipt-bound namespace crosses mount IDs")
finally:
...
validate_post_freeze_attempt_state() {
  ...
  actual_binding="$(validate_attempt_layout_against_log "$binding_log")" ||
    die "P29 post-freeze attempt binding validation failed"
  printf 'attempt_binding=%s\n' "$actual_binding"
  echo -n "runtime_lock_binding="
  validate_root_evidence_file \
    "$P29_HOST_EVIDENCE/p29_cuda_runtime_lock.json" - - 0444 0 0
  echo -n "host_attestation_binding="
  validate_root_evidence_file \
    "$P29_HOST_EVIDENCE/p29_host_attestation.json" - - 0444 0 0
}
...
transport_checkout_layout_binding() {
  ...
  local basename="$3"
  /usr/bin/python3 -I -S - \
    "$P29_TRANSPORT_ROOT" "$checkout" "$basename" "$label" <<'PY'
import os
import pathlib
import stat
import sys
...
if basename not in {"control-source", "authority-185e444"}:
    raise SystemExit("P29 checkout basename is not preregistered")
if checkout != transport / basename:
    raise SystemExit(f"P29 {label} path differs")
flags = os.O_RDONLY | os.O_DIRECTORY | getattr(os, "O_CLOEXEC", 0)
flags |= getattr(os, "O_NOFOLLOW", 0)
...
try:
    ...
    try:
        ...
        if not stat.S_ISDIR(checkout_info.st_mode):
            raise SystemExit(f"P29 {label} is not a directory")
        if (
            checkout_info.st_uid,
            checkout_info.st_gid,
            stat.S_IMODE(checkout_info.st_mode),
        ) != (1000, 1000, 0o700):
            raise SystemExit(f"P29 {label} owner or mode differs")
        if transport_info.st_dev != checkout_info.st_dev:
            raise SystemExit(f"P29 {label} crosses a device boundary")
        def mount_id(descriptor):
            for line in pathlib.Path(f"/proc/self/fdinfo/{descriptor}").read_text().splitlines():
                if line.startswith("mnt_id:"):
                    return int(line.split(":", 1)[1])
            raise SystemExit(f"P29 {label} descriptor has no mount ID")
        if mount_id(transport_fd) != mount_id(checkout_fd):
            raise SystemExit(f"P29 {label} crosses a mount-ID boundary")
        acl_names = {
            name.decode() if isinstance(name, bytes) else name
        ...
        if acl_names & {
            ...
            raise SystemExit(f"P29 {label} has an ACL")
        mount_points = {
            line.split()[4].replace("\\040", " ").replace("\\011", "\t")
            for line in pathlib.Path("/proc/self/mountinfo").read_text().splitlines()
            if len(line.split()) >= 5
        ...
        if str(checkout) in mount_points:
            raise SystemExit(f"P29 {label} is an unexpected mount point")
        by_name = os.stat(basename, dir_fd=transport_fd, follow_symlinks=False)
        if stat.S_ISLNK(by_name.st_mode) or (
            by_name.st_dev,
            by_name.st_ino,
        ) != (checkout_info.st_dev, checkout_info.st_ino):
            raise SystemExit(f"P29 {label} path identity differs")
        print(
...
authority_layout_binding() {
  transport_checkout_layout_binding \
    authority "$P29_AUTHORITY_REPO" authority-185e444
}

control_layout_binding() {
  transport_checkout_layout_binding \
    control "$P29_CONTROL_REPO" control-source
}

validate_authority_and_inputs() {
  local authority_binding_before
  authority_binding_before="$(authority_layout_binding)" ||
    die "P29 authority layout could not be bound"
  assert_clean_checkout \
    "$P29_AUTHORITY_REPO" "$P29_AUTHORITY_HEAD" "$P29_AUTHORITY_TREE" \
    "P29 authority checkout"
  local symbolic_status
  set +e
  p29_git -C "$P29_AUTHORITY_REPO" symbolic-ref -q HEAD >/dev/null 2>&1
  symbolic_status=$?
  set -e
  (( symbolic_status == 1 )) || {
    (( symbolic_status == 0 )) && die "P29 authority checkout must be detached"
    die "P29 authority symbolic-ref inspection failed"
  }
  local shallow_status
  shallow_status="$(p29_git -C "$P29_AUTHORITY_REPO" rev-parse --is-shallow-repository)" ||
    die "P29 authority shallow-state inspection failed"
  [[ "$shallow_status" == "false" ]] ||
    die "P29 authority checkout must not be shallow"
  local authority_indirection
  for authority_indirection in \
    "$P29_AUTHORITY_REPO/.git/objects/info/alternates" \
    "$P29_AUTHORITY_REPO/.git/info/grafts"; do
    [[ ! -e "$authority_indirection" && ! -L "$authority_indirection" ]] ||
      die "P29 authority checkout has forbidden Git object indirection: $authority_indirection"
  done
  local replace_refs
  replace_refs="$(p29_git -C "$P29_AUTHORITY_REPO" for-each-ref \
      --format='%(refname)' refs/replace/)" ||
    die "P29 authority replace-ref inspection failed"
  [[ -z "$replace_refs" ]] ||
    die "P29 authority checkout has forbidden replace refs"
  local partial_config partial_status
  set +e
  partial_config="$(p29_git -C "$P29_AUTHORITY_REPO" config --local --get-regexp \
      '^(extensions\.partialclone|remote\..*\.(promisor|partialclonefilter))$' \
      2>/dev/null)"
  partial_status=$?
  set -e
  (( partial_status == 0 || partial_status == 1 )) ||
    die "P29 authority partial-clone config inspection failed"
  [[ -z "$partial_config" ]] ||
    die "P29 authority checkout has forbidden promisor or partial-clone configuration"
  [[ "$(sha256_file "$P29_AUTHORITY_REPO/experiments/training/run_p25_executable_origin_diagnostic.py")" == \
      "$P29_P25_SOURCE_SHA256" ]] || die "authority P25 source bytes differ"
  [[ "$(sha256_file "$P29_AUTHORITY_REPO/experiments/training/p25_cuda_diagnostic_contract.json")" == \
      "$P29_P25_CONTRACT_SHA256" ]] || die "authority P25 contract bytes differ"
  [[ "$(sha256_file "$P29_AUTHORITY_REPO/experiments/training/run_p23_deterministic_cuda_shadow_trace.py")" == \
      "$P29_P23_RUNNER_SHA256" ]] || die "authority P23 runner bytes differ"

  assert_clean_checkout \
    "$P29_NANOGPT_HOST" "$P29_NANOGPT_COMMIT" "$P29_NANOGPT_TREE" \
    "pinned nanoGPT checkout"
  assert_clean_checkout \
    "$P29_MUON_HOST" "$P29_MUON_COMMIT" "$P29_MUON_TREE" \
    "pinned Muon checkout"
  [[ "$(sha256_file "$P29_MUON_HOST/muon.py")" == "$P29_MUON_SOURCE_SHA256" ]] ||
    die "pinned Muon source bytes differ"
  [[ -f "$P29_DATA_HOST/materialized/p22_fineweb_manifest.json" ]] ||
    die "FineWeb materialization manifest is absent"
  [[ -f "$P29_AUTHORITY_REPO/experiments/training/materialize_p22_fineweb.py" ]] ||
    die "preprocessor alias source is absent"
  local authority_binding_after
  authority_binding_after="$(authority_layout_binding)" ||
    die "P29 authority layout could not be rebound"
  [[ "$authority_binding_after" == "$authority_binding_before" ]] ||
    die "P29 authority directory identity changed during validation"
}
...
validate_control_sources() {
  ...
  control_binding_before="$(control_layout_binding)" ||
    die "P29 control layout could not be bound"
  assert_clean_checkout \
    "$P29_CONTROL_REPO" "$expected_head" "$expected_tree" "P29 control checkout"

  local contract="$P29_CONTROL_REPO/experiments/training/p29_permission_safe_bundle_localization_bridge_contract.json"
  local orchestrator="$P29_CONTROL_REPO/scripts/run_p29_permission_safe_bundle_localization_bridge.sh"
  local reconstructor="$P29_CONTROL_REPO/scripts/reconstruct_p29_permission_safe_bundle_localization_bridge.py"
  local bundle_verifier="$P29_CONTROL_REPO/scripts/verify_p29_control_bundle.py"
  local p28_contract="$P29_CONTROL_REPO/experiments/training/p28_bundle_complete_localization_bridge_contract.json"
  local p28_reconstructor="$P29_CONTROL_REPO/scripts/reconstruct_p28_bundle_complete_localization_bridge.py"
  local p28_outcome="$P29_CONTROL_REPO/results/summaries/p28_bundle_complete_localization_bridge_outcome.json"
  local p28_outcome_reconstructor="$P29_CONTROL_REPO/scripts/reconstruct_p28_bundle_complete_localization_bridge_outcome.py"
  local p27_contract="$P29_CONTROL_REPO/experiments/training/p27_cuda_deleted_mapping_localization_contract.json"
  local p27_reconstructor="$P29_CONTROL_REPO/scripts/reconstruct_p27_cuda_deleted_mapping_localization.py"
  local p27_localizer="$P29_CONTROL_REPO/experiments/training/run_p27_cuda_deleted_mapping_localization.py"
  local ingester="$P29_CONTROL_REPO/scripts/ingest_p26_trace_off_a_failure.py"
  local p23_core="$P29_CONTROL_REPO/experiments/training/p23_deterministic_cuda_shadow_trace.py"
  local p27_sanitizer="$P29_CONTROL_REPO/scripts/sanitize_p27_cuda_deleted_mapping_localization.py"
  local p23_runner="$P29_CONTROL_REPO/experiments/training/run_p23_deterministic_cuda_shadow_trace.py"
  ...
  [[ "$(sha256_file "$contract")" == "$P29_EXPECTED_CONTRACT_SHA256" ]] ||
    die "P29 contract bytes differ"
  [[ "$(sha256_file "$orchestrator")" == "$P29_EXPECTED_ORCHESTRATOR_SHA256" ]] ||
    die "P29 host orchestrator bytes differ"
  [[ "$executing_orchestrator" == "$P29_SEALED_ORCHESTRATOR" && \
     ! -L "${BASH_SOURCE[0]}" ]] ||
    die "the executing P29 orchestrator is not the root-sealed source"
  [[ "$(sha256_file "$executing_orchestrator")" == \
      "$P29_EXPECTED_ORCHESTRATOR_SHA256" ]] ||
    die "executing P29 host orchestrator bytes differ"
  [[ "$(sha256_file "$reconstructor")" == "$P29_EXPECTED_RECONSTRUCTOR_SHA256" ]] ||
    die "P29 contract reconstructor bytes differ"
  [[ "$(sha256_file "$bundle_verifier")" == "$P29_EXPECTED_BUNDLE_VERIFIER_SHA256" ]] ||
    die "P29 bundle verifier bytes differ"
  [[ "$(sha256_file "$p28_contract")" == "$P29_EXPECTED_P28_CONTRACT_SHA256" ]] ||
    die "frozen P28 contract bytes differ"
  [[ "$(sha256_file "$p28_reconstructor")" == "$P29_EXPECTED_P28_RECONSTRUCTOR_SHA256" ]] ||
    die "frozen P28 contract reconstructor bytes differ"
  [[ "$(sha256_file "$p28_outcome")" == "$P29_EXPECTED_P28_OUTCOME_SHA256" ]] ||
  ...
  [[ "$(sha256_file "$p27_contract")" == "$P29_EXPECTED_P27_CONTRACT_SHA256" ]] ||
    die "frozen P27 contract bytes differ"
  [[ "$(sha256_file "$p27_reconstructor")" == "$P29_EXPECTED_P27_RECONSTRUCTOR_SHA256" ]] ||
    die "frozen P27 contract reconstructor bytes differ"
  [[ "$(sha256_file "$p27_localizer")" == "$P29_EXPECTED_P27_LOCALIZER_SHA256" ]] ||
    die "frozen P27 localizer bytes differ"
  [[ "$(sha256_file "$ingester")" == "$P29_EXPECTED_INGESTER_SHA256" ]] ||
    die "P26 failure ingester bytes differ"
  [[ "$(sha256_file "$p23_core")" == "$P29_EXPECTED_P23_CORE_SHA256" ]] ||
    die "corrected P23 core bytes differ"
  [[ "$(sha256_file "$p27_sanitizer")" == "$P29_EXPECTED_P27_SANITIZER_SHA256" ]] ||
    die "frozen P27 sanitizer bytes differ"
  [[ "$(sha256_file "$p23_runner")" == "$P29_P23_RUNNER_SHA256" ]] ||
  ...
  for relative in \
    ...
    [[ "$(p29_git -C "$P29_CONTROL_REPO" ls-files --error-unmatch -- "$relative")" == \
        "$relative" ]] || die "reviewed control source is not tracked: $relative"
  done
  control_binding_after="$(control_layout_binding)" ||
    die "P29 control layout could not be rebound"
  [[ "$control_binding_after" == "$control_binding_before" ]] ||
    die "P29 control directory identity changed during validation"
}

validate_source_freeze_history() {
  [[ "$(p29_git -C "$P29_CONTROL_REPO" rev-parse \
      "$P29_SOURCE_FREEZE_COMMIT^{tree}")" == "$P29_SOURCE_FREEZE_TREE" ]] ||
    die "P29 source-freeze commit/tree binding differs"
  [[ "$(p29_git -C "$P29_CONTROL_REPO" rev-list --parents -n 1 \
      "$P29_SOURCE_FREEZE_COMMIT")" == \
      "$P29_SOURCE_FREEZE_COMMIT $P29_TERMINAL_P28_COMMIT" ]] ||
    die "P29 source freeze must be one direct child of the terminal P28 outcome"
  [[ "$(p29_git -C "$P29_CONTROL_REPO" rev-parse \
      "$P29_TERMINAL_P28_COMMIT^{tree}")" == "$P29_TERMINAL_P28_TREE" ]] ||
    die "terminal P28 commit/tree binding differs"
  if p29_git -C "$P29_CONTROL_REPO" cat-file -e \
    "$P29_SOURCE_FREEZE_COMMIT:experiments/training/p29_cuda_runtime_lock.json" \
    2>/dev/null || p29_git -C "$P29_CONTROL_REPO" cat-file -e \
    "$P29_SOURCE_FREEZE_COMMIT:experiments/training/p29_host_attestation.json" \
    2>/dev/null; then
    die "P29 runtime artifacts unexpectedly predate runtime preparation"
  fi
}
...
validate_runtime_review_history() {
  [[ "$(p29_git -C "$P29_CONTROL_REPO" rev-list --parents -n 1 \
      ...
      "$P29_RUNTIME_REVIEW_COMMIT $P29_SOURCE_FREEZE_COMMIT" ]] ||
    die "P29 runtime review must be one direct child of the source freeze"
  local expected_delta
  expected_delta=$'A\texperiments/training/p29_cuda_runtime_lock.json\nA\texperiments/training/p29_host_attestation.json'
  [[ "$(p29_git -C "$P29_CONTROL_REPO" diff --name-status \
      "$P29_SOURCE_FREEZE_COMMIT" "$P29_RUNTIME_REVIEW_COMMIT")" == \
      "$expected_delta" ]] ||
    die "runtime review must add only the P29 lock and host attestation"
  validate_source_freeze_history
}

validate_transport_execution_sources() {
  local orchestrator="$P29_CONTROL_REPO/scripts/run_p29_permission_safe_bundle_localization_bridge.sh"
  local verifier="$P29_CONTROL_REPO/scripts/verify_p29_control_bundle.py"
  local executing_orchestrator
  executing_orchestrator="$(/usr/bin/realpath -- "${BASH_SOURCE[0]}")"
  [[ -f "$orchestrator" && ! -L "$orchestrator" && \
     -f "$verifier" && ! -L "$verifier" && \
     -f "$P29_BOOTSTRAP_VERIFIER" && ! -L "$P29_BOOTSTRAP_VERIFIER" ]] ||
    die "P29 transport execution sources are absent or symlinks"
  [[ "$executing_orchestrator" == "$P29_SEALED_ORCHESTRATOR" && \
     ! -L "${BASH_SOURCE[0]}" ]] ||
    die "the executing P29 orchestrator is not the root-sealed source"
  [[ "$(sha256_file "$executing_orchestrator")" == \
      "$P29_EXPECTED_ORCHESTRATOR_SHA256" ]] ||
    die "executing P29 host orchestrator bytes differ before transport replay"
  [[ "$(sha256_file "$verifier")" == "$P29_EXPECTED_BUNDLE_VERIFIER_SHA256" ]] ||
    die "P29 bundle verifier bytes differ before transport replay"
  [[ "$(sha256_file "$P29_BOOTSTRAP_VERIFIER")" == \
      "$P29_EXPECTED_BUNDLE_VERIFIER_SHA256" ]] ||
    die "P29 bootstrap bundle verifier bytes differ before transport replay"
  [[ "$(/usr/bin/stat -c '%a' "$P29_BOOTSTRAP_VERIFIER")" == "600" ]] ||
    die "P29 bootstrap bundle verifier mode differs"
}
...
run_bootstrap_verifier() {
  ...
  /usr/bin/python3 -I -S - \
    "$P29_TRANSPORT_ROOT" "$P29_BOOTSTRAP_VERIFIER" \
    "$P29_EXPECTED_BUNDLE_VERIFIER_SHA256" "$@" <<'PY'
import hashlib
import os
import pathlib
import stat
...
if source != transport / "verify_p29_control_bundle.py":
    raise SystemExit("P29 bootstrap verifier is not the canonical direct child")
for name in ("O_CLOEXEC", "O_DIRECTORY", "O_NOFOLLOW"):
    value = getattr(os, name, None)
    if not isinstance(value, int) or value == 0:
        raise SystemExit(f"platform lacks mandatory {name}")
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 transport authority differs at bootstrap execution")
    ...
    if (
        ...
        raise SystemExit("P29 bootstrap verifier authority differs")
    raw = bytearray()
    digest = hashlib.sha256()
    while True:
        chunk = os.read(source_fd, 1024 * 1024)
    ...
    if digest.hexdigest() != expected_digest:
        raise SystemExit("P29 bootstrap verifier digest differs")
    ...
    if fields(before) != fields(after_read) or fields(after_read) != fields(by_name):
        raise SystemExit("P29 bootstrap verifier changed during authenticated read")
    ...
    if os.geteuid() != 0 or os.getegid() != 0:
        raise SystemExit("P29 bootstrap launcher did not start with root authority")
    os.setgroups([])
    os.setgid(1000)
    os.setuid(1000)
    if os.geteuid() != 1000 or os.getegid() != 1000 or os.getgroups():
        raise SystemExit("P29 bootstrap verifier privilege drop failed")
    ...
    if fields(after_read) != fields(after_exec) or fields(after_exec) != fields(by_name_after):
        raise SystemExit("P29 bootstrap verifier identity changed during execution")
finally:
...
verify_source_transport_unlogged() {
  ...
  run_bootstrap_verifier \
    ...
    --verify-existing-receipt "$P29_SOURCE_RECEIPT" \
    --expected-receipt-sha256 "$P29_EXPECTED_SOURCE_RECEIPT_SHA256" \
    >/dev/null || die "reviewed P29 source-bundle receipt did not replay exactly"
}
...
verify_runtime_review_transport_unlogged() {
  ...
  run_bootstrap_verifier \
    ...
    --verify-existing-receipt "$P29_RUNTIME_REVIEW_RECEIPT" \
    --expected-receipt-sha256 "$P29_EXPECTED_RUNTIME_REVIEW_RECEIPT_SHA256" \
    >/dev/null || die "reviewed P29 runtime-review bundle receipt did not replay exactly"
}

launch_fresh_container() {
  local container_id inspected_id
  container_id="$(p29_docker run "$@")" || return
  container_id="${container_id//$'\n'/}"
  [[ "$container_id" =~ ^[0-9a-f]{64}$ ]] ||
    die "fresh container ID is malformed"
  [[ "$container_id" != "$P29_TERMINAL_P26_CONTAINER_ID" ]] ||
    die "terminal P26 container was reused"
  inspected_id="$(p29_docker inspect --format '{{.Id}}' "$container_id")" ||
...
read_fresh_container_id() {
  /usr/bin/python3 -I -S - \
    "$P29_ATTEMPT_ROOT" "$P29_ATTEMPT_ROOT/p29-container-id.txt" \
    "$P29_TERMINAL_P26_CONTAINER_ID" <<'PY'
import os
import pathlib
import stat
import sys
...
if path != attempt / "p29-container-id.txt":
    raise SystemExit("P29 container-ID path differs")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 container-ID parent authority differs")
    file_fd = os.open(
        path.name,
        os.O_RDONLY | os.O_CLOEXEC | os.O_NOFOLLOW,
        dir_fd=attempt_fd,
    ...
    if os.read(file_fd, 1) != b"":
        raise SystemExit("P29 container-ID file is unexpectedly large")
    after = os.fstat(file_fd)
    ...
    if (
        ...
        raise SystemExit("P29 container-ID file identity or authority differs")
    try:
        value = raw.decode("ascii").removesuffix("\n")
    except UnicodeDecodeError as exc:
        raise SystemExit("P29 container ID is not ASCII") from exc
    if (
        len(value) != 64
        ...
        raise SystemExit("P29 container ID is malformed or forbidden")
    print(value)
finally:
    if file_fd is not None:
        os.close(file_fd)
...
freeze_runtime_from_bound_container() {
  ...
  p29_docker exec \
    --env "CUDA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    --env "NVIDIA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    ...
    freeze-runtime \
    --container-image "$P29_IMAGE" \
    --container-repository-digest "$P29_IMAGE_DIGEST" \
    ...
    --host-attestation-output /workspace/evidence/p23/p29_host_attestation.json \
    --runtime-lock-output /workspace/evidence/p23/p29_cuda_runtime_lock.json
}
...
capture_running_container_inspection() {
  ...
  inspection="$(p29_docker inspect "$expected_id")" ||
...
capture_running_mountinfo() {
  ...
  IFS=: read -r expected_id init_pid <<<"$(
    /usr/bin/python3 -I -S - \
      "$P29_ATTEMPT_ROOT/p29-running-container-inspect.json" <<'PY'
import json
import os
import stat
import sys
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 running-inspection file authority differs")
    raw = bytearray()
    while True:
        chunk = os.read(descriptor, 1024 * 1024)
        if not chunk:
    ...
    if fields(before) != fields(after) or fields(after) != fields(by_name):
        raise SystemExit("P29 running-inspection file changed during read")
    payload = json.loads(bytes(raw))
    if not isinstance(payload, list) or len(payload) != 1:
        raise SystemExit("P29 running-inspection payload differs")
    record = payload[0]
    ...
    if (
        ...
        raise SystemExit("P29 running-inspection ID or init PID is malformed")
    print(f"{container_id}:{pid}")
finally:
    os.close(descriptor)
PY
  )"
  current_id="$(p29_docker inspect --format '{{.Id}}' "$expected_id")" ||
    die "fresh container ID reinspection failed"
  current_pid="$(p29_docker inspect --format '{{.State.Pid}}' "$expected_id")" ||
...
create_fresh_attempt_layout() {
  sudo /usr/bin/python3 -I -S - \
    "$P29_NAMESPACE_ROOT" "$P29_TRANSPORT_ROOT" \
    "$P29_ATTEMPT_ROOT" "$P29_HOST_EVIDENCE" \
    "$P29_EXECUTION_ROOT" "$P29_AUTHORITY_REPO" \
    "$P29_NANOGPT_HOST" "$P29_MUON_HOST" "$P29_DATA_HOST" \
    "$P29_CONTROL_REPO" "$P29_P26_NATIVE" \
    "$P29_AUTHORITY_HEAD" "$P29_AUTHORITY_TREE" \
    "$P29_NANOGPT_COMMIT" "$P29_NANOGPT_TREE" \
    "$P29_MUON_COMMIT" "$P29_MUON_TREE" \
    "$P29_FINEWEB_MANIFEST_SHA256" "$P29_FINEWEB_MANIFEST_BYTE_COUNT" \
    "$P29_EXPECTED_P27_LOCALIZER_SHA256" "$P29_EXPECTED_INGESTER_SHA256" \
    "$P29_EXPECTED_P23_CORE_SHA256" "$P29_EXPECTED_P27_SANITIZER_SHA256" \
    "$P29_P26_NATIVE_SHA256" "$P29_P26_NATIVE_BYTE_COUNT" <<'PY'
import hashlib
import json
import os
import pathlib
...
if transport != namespace / "transport-20260906-02":
    raise SystemExit("P29 transport layout differs at attempt creation")
if attempt != namespace / "attempt-20260906-02" or evidence != attempt / "evidence":
    raise SystemExit("P29 attempt layout differs at creation")
if execution != namespace / "execution-20260906-02":
    raise SystemExit("P29 execution snapshot layout differs at creation")
if authority != transport / "authority-185e444" or control != transport / "control-source":
    raise SystemExit("P29 reviewed source checkout layout differs at snapshot creation")
for name in ("O_CLOEXEC", "O_DIRECTORY", "O_NOFOLLOW"):
    value = getattr(os, name, None)
    if not isinstance(value, int) or value == 0:
        raise SystemExit(f"platform lacks mandatory {name}")
...
for value in (
    ...
    if len(value) != 40 or any(character not in "0123456789abcdef" for character in value):
        raise SystemExit("P29 snapshot Git identity is malformed")
for value in (
    fineweb_manifest_sha256,
    localizer_sha256,
    ingester_sha256,
    ...
    if len(value) != 64 or any(character not in "0123456789abcdef" for character in value):
        raise SystemExit("P29 snapshot input digest is malformed")
...
def require_no_acl(descriptor: int, label: str) -> None:
    ...
    if names & ACL_NAMES:
        raise SystemExit(f"P29 snapshot source has a forbidden ACL: {label}")


def require_not_mount(path: pathlib.PurePosixPath) -> None:
    if str(path) in mount_points:
        raise SystemExit(f"P29 snapshot source crosses a mount point: {path}")
...
def copy_regular(
    ...
    try:
        ...
        if not stat.S_ISREG(before.st_mode) or before.st_nlink != 1:
            raise SystemExit(f"P29 snapshot input is not one regular file: {source_path}")
        ...
        if (
            ...
            raise SystemExit(f"P29 snapshot input changed during copy: {source_path}")
        ...
        if mode not in {0o444, 0o555}:
            raise SystemExit("P29 snapshot stored-file mode is not preregistered")
        destination_fd = os.open(
            destination_name,
            file_create_flags,
            0o600,
        ...
        for offset in range(0, len(payload), 1024 * 1024):
            ...
            while view:
                written = os.write(destination_fd, view)
                if written <= 0:
                    raise SystemExit("P29 snapshot write made no progress")
                view = view[written:]
        ...
        if (
            ...
            raise SystemExit(f"P29 snapshot input changed after authenticated read: {source_path}")
        if override is None and (
            output_digest.hexdigest() != source_digest or output_size != before.st_size
        ):
            raise SystemExit(f"P29 snapshot output differs from authenticated input: {source_path}")
        ...
        if (
            ...
            raise SystemExit(f"P29 snapshot stored-file authority differs: {relative}")
        entries.append(
            {
...
def copy_tree(
    ...
    for name in names_before:
        if name in {"", ".", ".."} or "/" in name or "\x00" in name:
            raise SystemExit("P29 snapshot input name is unsafe")
        child_source_path = source_path / name
        child_relative = relative / name
        child_info = os.stat(name, dir_fd=source_fd, follow_symlinks=False)
        if stat.S_ISLNK(child_info.st_mode):
            raise SystemExit(f"P29 snapshot input contains a symlink: {child_source_path}")
        if stat.S_ISDIR(child_info.st_mode):
            ...
            raise SystemExit(f"P29 snapshot input contains a special file: {child_source_path}")
    names_after = sorted(os.listdir(source_fd))
    after = os.fstat(source_fd)
    if names_after != names_before or stable_fields(before) != stable_fields(after):
        raise SystemExit(f"P29 snapshot directory changed during copy: {source_path}")
    if finalize_root:
        ...
        if (stored.st_uid, stored.st_gid, stat.S_IMODE(stored.st_mode)) != (0, 0, 0o555):
            raise SystemExit(f"P29 snapshot directory authority differs: {relative}")
        entries.append(
            {
                "relative_path": str(relative),
                "kind": "directory",
...
def copy_external_file(
    ...
    try:
        ...
        if actual_digest != expected_digest or (
            ...
            raise SystemExit(f"P29 snapshot adjunct source binding differs: {source}")
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 secure-parent authority differs at attempt creation")
    if (
        ...
        raise SystemExit("P29 namespace authority differs at attempt creation")
    children = sorted(os.listdir(namespace_fd))
    if children != ["transport-20260906-02"]:
        raise SystemExit(f"P29 pre-attempt namespace inventory differs: {children!r}")
    ...
    os.mkdir("attempt-20260906-02", 0o700, dir_fd=namespace_fd)
    ...
    for placeholder_name in (
        ...
        try:
            ...
            if (
                ...
                raise SystemExit("P29 bound placeholder authority differs")
        finally:
            os.close(placeholder_fd)

    os.mkdir("execution-20260906-02", 0o700, dir_fd=namespace_fd)
    os.fsync(namespace_fd)
    execution_fd = os.open("execution-20260906-02", flags, dir_fd=namespace_fd)
    source_specs = (
    ...
    for name, source, expected_head, expected_tree in source_specs:
        ...
        if expected_head is not None and expected_tree is not None:
            ...
            if any(pathlib.Path(path).exists() or pathlib.Path(path).is_symlink() for path in forbidden_git_paths):
                raise SystemExit(f"P29 snapshot {name} contains Git object indirection")
            if git_value(snapshot_repository, "rev-parse", "HEAD") != expected_head:
                raise SystemExit(f"P29 snapshot {name} HEAD differs")
            if git_value(snapshot_repository, "rev-parse", "HEAD^{tree}") != expected_tree:
                raise SystemExit(f"P29 snapshot {name} tree differs")
            if git_value(
                snapshot_repository,
                "status",
                "--porcelain=v1",
                ...
                raise SystemExit(f"P29 snapshot {name} worktree is not exact")
            if git_value(
                snapshot_repository,
                "for-each-ref",
                "--format=%(refname)",
                ...
                raise SystemExit(f"P29 snapshot {name} contains replacement refs")
            ...
            for line in config_lines:
                ...
                if not separator or key.lower() in config:
                    raise SystemExit(f"P29 snapshot {name} Git config is malformed")
            ...
            if config != {
                ...
                raise SystemExit(f"P29 snapshot {name} Git config differs")
    ...
    tools_fd = None
    try:
        if ".p29-tools" in os.listdir(data_fd):
            raise SystemExit("P29 data source collides with the reserved adjunct")
        os.mkdir(".p29-tools", 0o700, dir_fd=data_fd)
        tools_fd = os.open(".p29-tools", flags, dir_fd=data_fd)
        helper_specs = (
            (
        ...
        for source, name, expected_digest, expected_size, stored_mode in helper_specs:
            actual_digest, actual_size = copy_external_file(
                ...
                tools_fd,
                name,
                pathlib.PurePosixPath("data/.p29-tools") / name,
                expected_digest,
                expected_size,
                stored_mode,
            )
    ...
    if (
        ...
        raise SystemExit("P29 snapshot FineWeb manifest binding differs")
    ...
    manifest_payload = {
        "schema_version": "passive-muon-p29-immutable-execution-snapshot-v1",
    ...
    try:
        ...
        while view:
            ...
            if written <= 0:
                raise SystemExit("P29 snapshot manifest write made no progress")
            view = view[written:]
...
prepare_runtime_admission() {
  ...
  [[ ! -e "$P29_ATTEMPT_ROOT" && ! -L "$P29_ATTEMPT_ROOT" && \
     ! -e "$P29_EXECUTION_ROOT" && ! -L "$P29_EXECUTION_ROOT" ]] ||
  ...
  # and current P29 contract must all reconstruct before state creation.
  # No attempt-root directory, evidence log, or container may predate these
  # two fail-closed checks.
  verify_source_transport_unlogged
  validate_namespace_layout
  validate_control_sources "$P29_SOURCE_FREEZE_COMMIT" "$P29_SOURCE_FREEZE_TREE"
  validate_source_freeze_history
  validate_localization_ledger present absent absent absent
  [[ ! -e "$P29_ATTEMPT_ROOT" && ! -L "$P29_ATTEMPT_ROOT" && \
     ! -e "$P29_EXECUTION_ROOT" && ! -L "$P29_EXECUTION_ROOT" ]] ||
    die "source replay created a forbidden attempt or execution root"
  if p29_docker container inspect "$P29_CONTAINER" >/dev/null 2>&1; then
    die "fresh container name already has state"
  fi
  validate_authority_and_inputs
  validate_namespace_layout
  [[ "$(p29_docker image inspect --format '{{.Id}}' "$P29_IMAGE")" == \
      "$P29_IMAGE_DIGEST" ]] || die "reviewed P29 image digest is unavailable"
}

prepare_runtime() {
  run_root_journal_logged p29-prepare-pre-attempt-admission \
    prepare_runtime_admission
  run_logged_deferred_evidence p29-prepare-attempt-layout \
    create_fresh_attempt_layout
  run_logged p29-prepare-execution-snapshot-verification \
    validate_prepare_snapshot_boundary

  refresh_bound_file p29-image-inspection "$P29_ATTEMPT_ROOT/p29-image-inspect.json" \
    p29_docker image inspect "$P29_IMAGE"
  refresh_bound_file p29-nvidia-smi "$P29_ATTEMPT_ROOT/p29-nvidia-smi.csv" \
    nvidia-smi --id="$P29_GPU_UUID" \
    --query-gpu=uuid,pci.bus_id,name,driver_version,vbios_version,memory.total,mig.mode.current \
    --format=csv,noheader,nounits
  refresh_bound_file p29-container-launch "$P29_ATTEMPT_ROOT/p29-container-id.txt" \
    launch_fresh_container --detach --name "$P29_CONTAINER" \
    --gpus "device=$P29_GPU_UUID" \
    --user 0:0 \
    --userns host \
    --cap-drop ALL \
    ...
    --mount type=bind,src="$P29_EXECUTION_ROOT/repository",dst=/workspace/OptimizationML,readonly \
    --mount type=bind,src="$P29_EXECUTION_ROOT/nanogpt",dst=/workspace/inputs/nanoGPT,readonly \
    --mount type=bind,src="$P29_EXECUTION_ROOT/muon",dst=/workspace/inputs/muon,readonly \
    --mount type=bind,src="$P29_EXECUTION_DATA",dst=/private/tmp/optimizationml-p22-data,readonly \
    --mount type=bind,src="$P29_EXECUTION_ROOT/repository/experiments/training/materialize_p22_fineweb.py",dst=/Users/harry/Desktop/temp/OptimizationML/experiments/training/materialize_p22_fineweb.py,readonly \
    --mount type=bind,src="$P29_HOST_EVIDENCE",dst=/workspace/evidence/p23 \
    --mount type=bind,src="$P29_ATTEMPT_ROOT/p29-image-inspect.json",dst=/mounted-host-evidence/image-inspect.json,readonly \
    --mount type=bind,src="$P29_ATTEMPT_ROOT/p29-running-container-inspect.json",dst=/mounted-host-evidence/running-container-inspect.json,readonly \
    --mount type=bind,src="$P29_ATTEMPT_ROOT/p29-running-mountinfo.txt",dst=/mounted-host-evidence/running-mountinfo.txt,readonly \
    --mount type=bind,src="$P29_ATTEMPT_ROOT/p29-nvidia-smi.csv",dst=/mounted-host-evidence/nvidia-smi.csv,readonly \
    --entrypoint /bin/sh \
    "$P29_IMAGE" -c 'while :; do sleep 3600; done'

  run_logged p29-fresh-container-id-validation read_fresh_container_id

  refresh_bound_file p29-running-container-inspection \
    "$P29_ATTEMPT_ROOT/p29-running-container-inspect.json" \
    capture_running_container_inspection
  refresh_bound_file p29-running-mountinfo \
    "$P29_ATTEMPT_ROOT/p29-running-mountinfo.txt" \
    capture_running_mountinfo

  local freeze_status=0
  set +e
  run_logged p29-freeze-runtime freeze_runtime_from_bound_container
  freeze_status=$?
  set -e
  (( freeze_status == 0 )) ||
    die "P29 freeze-runtime failed with exit $freeze_status; attempt is retained"
  run_logged p29-post-freeze-attempt-layout \
    validate_post_freeze_attempt_state \
      "$P29_HOST_EVIDENCE/p29-prepare-attempt-layout.stdout.log"

  echo "P29 runtime frozen; localization has not run."
  echo "Container identity and both artifact bindings are retained in the logged prepare evidence."
  echo "Review and commit exactly the two runtime artifacts as one direct child of $P29_SOURCE_FREEZE_COMMIT."
}

validate_live_runtime() {
  local label="$1"
  run_logged "$label-container-inspect" p29_docker inspect "$P29_EXPECTED_CONTAINER_ID"
  run_logged "$label-mountinfo" p29_docker exec "$P29_EXPECTED_CONTAINER_ID" \
    /usr/bin/cat /proc/self/mountinfo
  run_logged "$label-nvidia-smi" nvidia-smi --id="$P29_GPU_UUID" \
    --query-gpu=uuid,pci.bus_id,name,driver_version,vbios_version,memory.total,mig.mode.current \
    --format=csv,noheader,nounits

  run_logged "$label-runtime-binding-validation" /usr/bin/python3 -I -S - \
    "$P29_CONTROL_REPO/experiments/training/p29_cuda_runtime_lock.json" \
    "$P29_CONTROL_REPO/experiments/training/p29_host_attestation.json" \
    "$P29_HOST_EVIDENCE/$label-container-inspect.stdout.log" \
    "$P29_HOST_EVIDENCE/$label-mountinfo.stdout.log" \
    "$P29_HOST_EVIDENCE/$label-nvidia-smi.stdout.log" \
    "$P29_ATTEMPT_ROOT/p29-nvidia-smi.csv" \
    "$P29_ATTEMPT_ROOT/p29-container-id.txt" \
    "$P29_IMAGE" "$P29_IMAGE_DIGEST" "$P29_GPU_UUID" \
    "$P29_EXECUTION_ROOT/repository" "$P29_EXECUTION_ROOT/nanogpt" \
    "$P29_EXECUTION_ROOT/muon" "$P29_EXECUTION_DATA" \
    "$P29_HOST_EVIDENCE" "$P29_EXPECTED_CONTAINER_ID" \
    "$P29_EXPECTED_RUNTIME_LOCK_SHA256" "$P29_EXPECTED_HOST_ATTESTATION_SHA256" <<'PY'
import hashlib
import json
import os
import pathlib
...
def stable_bytes(path_text, uid, gid, mode, expected_sha256=None):
    ...
    try:
        ...
        if (
            ...
            raise SystemExit(f"live P29 input authority differs: {path}")
        acl_names = {
            item.decode() if isinstance(item, bytes) else item
            for item in os.listxattr(descriptor)
        }
        if acl_names & {
            ...
            raise SystemExit(f"live P29 input has a forbidden ACL: {path}")
        raw = bytearray()
        digest = hashlib.sha256()
        while True:
            chunk = os.read(descriptor, 1024 * 1024)
        ...
        if fields(before) != fields(after) or fields(after) != fields(by_name):
            raise SystemExit(f"live P29 input changed during read: {path}")
        if expected_sha256 is not None and digest.hexdigest() != expected_sha256:
            raise SystemExit(f"live P29 input digest differs: {path}")
        return bytes(raw)
    finally:
        if descriptor is not None:
            os.close(descriptor)
...
try:
    ...
    raise SystemExit("live P29 container-ID file is not ASCII") from exc
if container_id_raw != (container_id + "\n").encode("ascii"):
    raise SystemExit("live P29 container-ID bytes differ")
if container_id == (
...
expected_mounts = {
    ...
    "/mounted-host-evidence/image-inspect.json": (
        str(pathlib.Path(evidence).parent / "p29-image-inspect.json"), False
    ),
    "/mounted-host-evidence/running-container-inspect.json": (
        str(pathlib.Path(evidence).parent / "p29-running-container-inspect.json"), False
    ),
    "/mounted-host-evidence/running-mountinfo.txt": (
        str(pathlib.Path(evidence).parent / "p29-running-mountinfo.txt"), False
    ),
    "/mounted-host-evidence/nvidia-smi.csv": (
        str(pathlib.Path(evidence).parent / "p29-nvidia-smi.csv"), False
    ),
}
...
if failed:
    raise SystemExit(f"live P29 runtime validation failed: {failed}")
PY
}

validate_reviewed_runtime_artifacts() {
  local committed_lock="$P29_CONTROL_REPO/experiments/training/p29_cuda_runtime_lock.json"
  local committed_attestation="$P29_CONTROL_REPO/experiments/training/p29_host_attestation.json"
  local native_lock="$P29_HOST_EVIDENCE/p29_cuda_runtime_lock.json"
  local native_attestation="$P29_HOST_EVIDENCE/p29_host_attestation.json"
  [[ -f "$committed_lock" && ! -L "$committed_lock" && \
     -f "$committed_attestation" && ! -L "$committed_attestation" ]] ||
    die "reviewed P29 runtime artifacts are incomplete"
  [[ "$(sha256_file "$committed_lock")" == "$P29_EXPECTED_RUNTIME_LOCK_SHA256" ]] ||
    die "committed P29 runtime lock differs"
  [[ "$(sha256_file "$committed_attestation")" == "$P29_EXPECTED_HOST_ATTESTATION_SHA256" ]] ||
    die "committed P29 host attestation differs"
  validate_root_evidence_file \
    "$native_lock" "$P29_EXPECTED_RUNTIME_LOCK_SHA256" - 0444 0 0
  validate_root_evidence_file \
    "$native_attestation" "$P29_EXPECTED_HOST_ATTESTATION_SHA256" - 0444 0 0
}
...
if not names or any(not name or "/" in name or name in {".", ".."} for name in names):
    raise SystemExit("P29 absent-output name inventory is malformed")
flags = os.O_RDONLY | os.O_CLOEXEC | os.O_DIRECTORY | os.O_NOFOLLOW
descriptor = os.open("/", flags)
try:
    for component in evidence.parts[1:]:
    ...
    if (
        ...
        raise SystemExit("P29 absent-output evidence authority differs")
    for name in names:
        try:
            os.stat(name, dir_fd=descriptor, follow_symlinks=False)
        except FileNotFoundError:
            continue
        raise SystemExit(f"P29 one-shot output already exists: {name}")
finally:
    os.close(descriptor)
PY
}
...
try:
    ...
    if (
        ...
        raise SystemExit("P29 P26-ingestion evidence authority differs")
    ...
    def read_bound(name, digest_expected=None, size_expected=None):
        ...
        try:
            ...
            if (
                ...
                raise SystemExit(f"P29 retained P26 file authority differs: {name}")
            if {
                value.decode() if isinstance(value, bytes) else value
                for value in os.listxattr(descriptor)
            } & {
                ...
                raise SystemExit(f"P29 retained P26 file has an ACL: {name}")
            raw = bytearray()
            digest = hashlib.sha256()
            while True:
                chunk = os.read(descriptor, 1024 * 1024)
            ...
            if fields(before) != fields(after) or fields(after) != fields(by_name):
                raise SystemExit(f"P29 retained P26 file changed during read: {name}")
            actual_digest = digest.hexdigest()
            if digest_expected is not None and actual_digest != digest_expected:
                raise SystemExit(f"P29 retained P26 file digest differs: {name}")
            if size_expected is not None and after.st_size != size_expected:
                raise SystemExit(f"P29 retained P26 file size differs: {name}")
...
if (
    ...
    raise SystemExit("P29 sanitized P26 ingestion wrapper differs")
print(
...
sanitize_localization_artifact() {
  ...
  binding="$(validate_root_evidence_file "$native" - - 0444 0 0)" ||
    die "P29 native localization artifact could not be bound for sanitization"
  IFS=: read -r native_sha256 native_byte_count remainder <<<"$binding"
  [[ "$native_sha256" =~ ^[0-9a-f]{64}$ && \
     "$native_byte_count" =~ ^[1-9][0-9]*$ && -n "$remainder" ]] ||
    die "P29 native localization binding is malformed"
  printf 'native_binding=%s\n' "$binding"
  p29_docker exec \
    --env "CUDA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    --env "NVIDIA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    "$P29_EXPECTED_CONTAINER_ID" /opt/p23-venv/bin/python \
    /private/tmp/optimizationml-p22-data/.p29-tools/sanitize_p27_cuda_deleted_mapping_localization.py \
  ...
  seal_retained_file "$sanitized" || die "P29 sanitized artifact could not be sealed"
...
validate_localization_entry_state() {
  ...
  [[ -d "$P29_HOST_EVIDENCE" && ! -L "$P29_HOST_EVIDENCE" ]] ||
    die "fresh P29 evidence directory is absent or a symlink"
  validate_fresh_attempt_layout
}
...
run_localization() {
  ...
  run_logged_deferred_evidence p29-pre-marker-runtime-receipt-replay \
    verify_runtime_review_transport_unlogged
  run_logged p29-localization-entry-preflight validate_localization_entry_state
  run_logged p29-pre-marker-receipt-namespace-binding \
    validate_after_runtime_receipt_boundary
  run_logged p29-pre-marker-control-sources \
    validate_control_sources "$P29_RUNTIME_REVIEW_COMMIT" "$P29_RUNTIME_REVIEW_TREE"
  run_logged p29-pre-marker-runtime-history validate_runtime_review_history
  run_logged p29-pre-marker-authority-inputs validate_authority_and_inputs
  run_logged p29-pre-marker-runtime-artifacts validate_reviewed_runtime_artifacts
  run_logged p29-pre-marker-namespace-revalidation validate_namespace_layout
  run_logged p29-pre-marker-snapshot-layout validate_fresh_attempt_layout
  validate_live_runtime p29-pre-ingestion

  local p26_native_copy="$P29_HOST_EVIDENCE/p26-trace-off-a-failure.authenticated.json"
  local p26_sanitized="$P29_HOST_EVIDENCE/p26-trace-off-a-failure.sanitized.json"
  local ingestion_status=0
  set +e
  run_logged p29-p26-failure-ingestion run_p26_ingestion_once \
    p26-trace-off-a-failure.authenticated.json \
    p26-trace-off-a-failure.sanitized.json \
    p29_docker exec \
    --env "CUDA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    --env "NVIDIA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    "$P29_EXPECTED_CONTAINER_ID" /opt/p23-venv/bin/python \
    /private/tmp/optimizationml-p22-data/.p29-tools/ingest_p26_trace_off_a_failure.py \
    --source /private/tmp/optimizationml-p22-data/.p29-tools/p26-trace-off-a-failure.authenticated.json \
    ...
    --p23-core /private/tmp/optimizationml-p22-data/.p29-tools/p23_deterministic_cuda_shadow_trace.py \
  ...
  ingestion_status=$?
  set -e
  run_logged p29-post-ingestion-receipt-namespace-binding \
    validate_runtime_namespace_against_receipt
  (( ingestion_status == 0 )) ||
    die "terminal P26 failure ingestion failed with exit $ingestion_status before localization"
  run_logged p29-post-ingestion-artifacts validate_p26_ingestion_artifacts

  run_logged p29-pre-localization-control-sources \
    validate_control_sources "$P29_RUNTIME_REVIEW_COMMIT" "$P29_RUNTIME_REVIEW_TREE"
  run_logged p29-pre-localization-authority-inputs validate_authority_and_inputs
  run_logged p29-pre-localization-runtime-artifacts validate_reviewed_runtime_artifacts
  run_logged p29-pre-localization-receipt-namespace-binding \
    validate_runtime_namespace_against_receipt
  validate_live_runtime p29-pre-localization
  ...
  authorize_localization
  run_logged p29-post-authorization-ledger-validation \
    validate_localization_ledger present present present absent
  run_logged p29-post-authorization-receipt-namespace-binding \
    validate_runtime_namespace_against_receipt

  local native="$P29_HOST_EVIDENCE/p29_cuda_deleted_mapping_localization.native.json"
  local sanitized="$P29_HOST_EVIDENCE/p29_cuda_deleted_mapping_localization.sanitized.json"
  local localization_status=0
  set +e
  run_logged p29-localization run_localizer_once \
    p29_cuda_deleted_mapping_localization.native.json \
    p29_cuda_deleted_mapping_localization.sanitized.json \
    --env "CUDA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    --env "NVIDIA_VISIBLE_DEVICES=$P29_GPU_UUID" \
    "$P29_EXPECTED_CONTAINER_ID" /opt/p23-venv/bin/python \
    /private/tmp/optimizationml-p22-data/.p29-tools/run_p27_cuda_deleted_mapping_localization.py \
    ...
    --runtime-lock /workspace/evidence/p23/p29_cuda_runtime_lock.json \
    --host-attestation /workspace/evidence/p23/p29_host_attestation.json \
    --p25-contract /workspace/OptimizationML/experiments/training/p25_cuda_diagnostic_contract.json \
    --expected-source-sha256 "$P29_EXPECTED_P27_LOCALIZER_SHA256" \
    --expected-p25-source-sha256 "$P29_P25_SOURCE_SHA256" \
    --expected-p25-contract-sha256 "$P29_P25_CONTRACT_SHA256" \
    --expected-runtime-lock-sha256 "$P29_EXPECTED_RUNTIME_LOCK_SHA256" \
    --expected-host-attestation-sha256 "$P29_EXPECTED_HOST_ATTESTATION_SHA256" \
    --expected-repository-head "$P29_AUTHORITY_HEAD" \
    --expected-repository-tree "$P29_AUTHORITY_TREE" \
    --output /workspace/evidence/p23/p29_cuda_deleted_mapping_localization.native.json
  localization_status=$?
  set -e
  run_logged p29-post-localizer-receipt-namespace-binding \
    validate_runtime_namespace_against_receipt
  run_logged p29-post-localizer-ledger-validation \
    validate_localization_ledger present present present absent

  local native_binding_status=0
  set +e
  run_logged p29-native-localization-binding \
    validate_root_evidence_file "$native" - - 0444 0 0
  native_binding_status=$?
  set -e
  (( native_binding_status == 0 )) ||
    die "P29 localization retained no valid native artifact (localizer exit $localization_status, binding exit $native_binding_status); no rerun is allowed"

  local sanitizer_status=0
  set +e
  run_logged p29-localization-sanitizer sanitize_localization_artifact \
    "$native" "$sanitized" \
    /workspace/evidence/p23/p29_cuda_deleted_mapping_localization.native.json \
    /workspace/evidence/p23/p29_cuda_deleted_mapping_localization.sanitized.json \
    --output-root /workspace/evidence/p23 \
    --runner-source /private/tmp/optimizationml-p22-data/.p29-tools/run_p27_cuda_deleted_mapping_localization.py \
    --repository-root /workspace/OptimizationML \
    --path-root repository=/workspace/OptimizationML \
    --path-root nanogpt=/workspace/inputs/nanoGPT \
    --path-root muon=/workspace/inputs/muon \
  ...
  sanitizer_status=$?
  set -e
  run_logged p29-post-sanitizer-receipt-namespace-binding \
    validate_runtime_namespace_against_receipt
  run_logged p29-post-sanitizer-ledger-validation \
    validate_localization_ledger present present present absent
  (( sanitizer_status == 0 )) ||
    die "P29 localization sanitizer failed with exit $sanitizer_status; native evidence is retained"
  (( localization_status == 0 )) ||
    die "P29 localization completed with exit $localization_status; sanitized failure evidence is retained"
  run_logged p29-post-localization-receipt-namespace-binding \
    validate_runtime_namespace_against_receipt

  echo "P29 sole localization invocation and sanitizer completed. Do not rerun."
  echo "Native and sanitized artifact bindings are retained in the logged evidence."
}

usage() {
  cat >&2 <<'EOF'
usage: scripts/run_p29_permission_safe_bundle_localization_bridge.sh prepare-runtime|run-localization
...
case "$1" in
  ...
  run-localization)
    ...
    write_localization_exit_status "$localization_exit_status" ||
      die "P29 terminal localization status could not be retained"
