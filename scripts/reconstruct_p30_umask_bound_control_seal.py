...
EXPECTED_CONTRACT_SHA256 = "1a7a2e7a958725920411b301e6ad43cd3f05beb5d84d3b5a3e52b11efc3dee00"
...
def reconstruct(contract_path: Path = DEFAULT_CONTRACT) -> dict[str, object]:
    ...
    checks = {
        ...
        "fresh_attempt_locked_runtime_and_two_file_review_exact": (
            ...
            == (
                "Correct the machine-readable source-receipt review and root-seal order, "
                "require a real Linux UID-1000-to-root engineering rehearsal, and retain "
                "client command streams without changing the P30 diagnostic stages or "
                "scientific gates."
            )
            and freeze.get(
