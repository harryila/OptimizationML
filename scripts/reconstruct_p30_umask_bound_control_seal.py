...
EXPECTED_CONTRACT_SHA256 = "66ac18aca9f1454640fa56dc4c84fb79b13870ae9059873e810168ba1ca170c6"
...
def reconstruct(contract_path: Path = DEFAULT_CONTRACT) -> dict[str, object]:
    ...
    checks = {
        ...
        "host_orchestrator_final_hashes_and_one_shot_order_exact": (
            ...
            is True
            and orchestration.get("p27_sanitizer_native_mode_bridge")
            == {
                "purpose": (
                    "satisfy the unchanged P27 sanitizer's exact private-input mode "
                    "after P30 has sealed the retained native artifact"
                ),
